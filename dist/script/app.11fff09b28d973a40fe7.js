...
/******/ 	var hotCurrentHash = "11fff09b28d973a40fe7"; // eslint-disable-line no-unused-vars
...
// var API_URL = "/api";
var API_URL = "../mock";
var PATAINT_API_URL = "../mock";
var API_URL = "/dapi";
var PATAINT_API_URL = "/papi";
// var API_URL = "https://doctor.5aszy.com";
// var PATAINT_API_URL = "https://patient.5aszy.com";
...
new Vue({
  ...
  methods: {
    ...
    getCaseInfo: function () {
      var _this = this;
      var url = "/api/case/";
      $.get(API_URL + url + this.caseId +".json",function (res) {
        if(res.code == 200){
